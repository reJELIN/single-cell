...
if(species_ensembl == "human"){ensemble2gene <- read.table(file="/mnt/beegfs02/pipelines/bigr_single-cell/1.3_lr/common/database/ensembl_hsapiens.txt",header=T,sep="\t")}

if(species_ensembl == "mouse"){ensemble2gene <- read.table(file="/mnt/beegfs02/pipelines/bigr_single-cell/1.3_lr/common/database/ensembl_mmusculus.txt",header=T,sep="\t")}
